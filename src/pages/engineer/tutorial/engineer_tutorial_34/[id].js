...
import { Layout_tutorial_34 } from '../../../../components/layout/engineer/tutorial/Layout_tutorial';
        ...
        <div>
            {
                id == 1 ? (
                  ...
                  <iframe width="560" height="315" src="https://www.youtube.com/embed/XtMThy8QKqU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                  </div>
                  <h3>#エラーが発生した場合</h3>
                  ...
                  <Tutorial3422 />
                  <p>App.test.jsとlogo.svgとsetupTests.jsは必要ないので削除しておきます。</p>
                  <p>。</p>
                  <p></p>
                  ...
                  <h4>axios.js作成</h4>
                  <p></p>
                  <p className='text-red-400'>src/axios.js</p>
                  <Tutorial3431 />
                  <h4>Row.js作成</h4>
                  <p className='text-red-400'>app.js</p>
                  <Tutorial3432 />

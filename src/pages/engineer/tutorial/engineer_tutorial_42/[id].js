        ...
        <div>
            {
                id == 1 ? (
                  ...
                  <iframe width="560" height="315" src="https://www.youtube.com/embed/jmvbhuJXFow" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                  </div>
                  <h3>#エラーが発生した場合</h3>
...
const Tutorial4221 = () => {
  const test = `
  npx create-react-native-app uber-eats-clone-live-youtube
  `
  return (

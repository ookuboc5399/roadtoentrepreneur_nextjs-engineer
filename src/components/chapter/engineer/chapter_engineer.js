          ...
          <nav className="">
            <Link href="./aws_detail">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                ...
                {router.pathname == '/engineer/AWS/1/engineer_aws_detail' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">AWSって何？</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">AWSって何？</span>
                )}
              </div>
            </Link>
            <Link href="./cloud_detail">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                {router.pathname == '/engineer/AWS/1/engineer_cloud_detail' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">クラウドとは</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">クラウドとは</span>
                )}
              </div>
            </Link>
            <Link href="./begin_detail">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M17 14v6m-3-3h6M6 10h2a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2zm10 0h2a2 2 0 002-2V6a2 2 0 00-2-2h-2a2 2 0 00-2 2v2a2 2 0 002 2zM6 20h2a2 2 0 002-2v-2a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2z"></path>
                </svg>

                {router.pathname == '/engineer/AWS/1/engineer_begin_detail' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">AWSを始める</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">AWSを始める</span>
                )}
              </div>
            </Link>
            <Link href="./amazonec2_detail">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M17 14v6m-3-3h6M6 10h2a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2zm10 0h2a2 2 0 002-2V6a2 2 0 00-2-2h-2a2 2 0 00-2 2v2a2 2 0 002 2zM6 20h2a2 2 0 002-2v-2a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2z"></path>
                </svg>

                {router.pathname == '/engineer/AWS/1/engineer_amazonec2_detail' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">AmazonEC2</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">AmazonEC2</span>
                )}
              </div>
            </Link>
            <Link href="./amazonrds_detail">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M17 14v6m-3-3h6M6 10h2a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2zm10 0h2a2 2 0 002-2V6a2 2 0 00-2-2h-2a2 2 0 00-2 2v2a2 2 0 002 2zM6 20h2a2 2 0 002-2v-2a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2z"></path>
                </svg>

                {router.pathname == '/engineer/AWS/1/engineer_amazonrds_detail' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">AmazonRDS</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">AmazonRDS</span>
                )}
              </div>
            </Link>
            <Link href="./api_gate">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                ...
                {router.pathname == '/engineer/AWS/1/engineer_amazonrds_detail' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">Amazon API Gateway</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">Amazon API Gateway</span>
                )}
              </div>
            </Link>
          </nav>
          ...
          <nav className="">
            <Link href="./azure_detail">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                ...
                {router.pathname == '/engineer/AWS/1/engineer_aws_detail' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">Azure</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">Azure</span>
                )}
              </div>
            </Link>

            <Link href="./azure_iaas">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M17 14v6m-3-3h6M6 10h2a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2zm10 0h2a2 2 0 002-2V6a2 2 0 00-2-2h-2a2 2 0 00-2 2v2a2 2 0 002 2zM6 20h2a2 2 0 002-2v-2a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2z"></path>
                </svg>
                ...
                {router.pathname == '/engineer/AWS/1/engineer_begin_detail' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">Azure2</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">Azure2</span>
                )}
              </div>
            </Link>
            <Link href="./azure_portal">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M17 14v6m-3-3h6M6 10h2a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2zm10 0h2a2 2 0 002-2V6a2 2 0 00-2-2h-2a2 2 0 00-2 2v2a2 2 0 002 2zM6 20h2a2 2 0 002-2v-2a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2z"></path>
                </svg>
                ...
                {router.pathname == '/engineer/AWS/1/engineer_cloud_detail' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">Azureポータル</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">Azureポータル</span>
                )}
              </div>
            </Link>
          </nav>
          ...
          <nav className="">
            ...
            <Link href="./azure_iaas">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                ...
                {router.pathname == '/engineer/AWS/1/engineer_begin_detail' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">オンプレミスからAzure</span>
                ) : (
          ...
          <nav className="">
            ...
            <Link href="./1">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                ...
                {router.pathname == '/engineer/AWS/1/engineer_begin_detail' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">TCP/IP</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">TCP/IP</span>
                )}
              </div>
            </Link>
            <Link href="./engineer_amazonec2_detail">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M17 14v6m-3-3h6M6 10h2a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2zm10 0h2a2 2 0 002-2V6a2 2 0 00-2-2h-2a2 2 0 00-2 2v2a2 2 0 002 2zM6 20h2a2 2 0 002-2v-2a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2z"></path>
                </svg>
            ...
            <Link href="./engineer_amazonrds_detail">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M17 14v6m-3-3h6M6 10h2a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2zm10 0h2a2 2 0 002-2V6a2 2 0 00-2-2h-2a2 2 0 00-2 2v2a2 2 0 002 2zM6 20h2a2 2 0 002-2v-2a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2z"></path>
                </svg>
            ...
            </Link>engineer_amazonec2_detail
          </nav>
        </div>
      </div>
    </div>
    ...
    <div className="bg-gray-200">
      <div className="bg-gray-900">
        <div>
          ...
          <nav className="">
            <Link href="./engineer_mongo_detail">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"></path>
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"></path>
                ...
                {router.pathname == '/engineer/SQL/2/engineer_mongo_detail' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">MongoDB</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">MongoDB</span>
                )}
              </div>
            </Link>
            <Link href="./engineer_mongo_detail_install">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"></path>
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"></path>
                ...
                {router.pathname == '/engineer/SQL/2/engineer_mongo_detail_install' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">MongoDBインストール</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">MongoDBインストール</span>
                )}
              </div>
            </Link>
            <Link href="./engineer_mongo_detail_2">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"></path>
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"></path>
                ...
                {router.pathname == '/engineer/SQL/2/engineer_mongo_detail_2' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">MongoDB操作</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">MongoDB操作</span>
                )}
              </div>
            </Link>engineer_mongoose_detail
            <Link href="./engineer_mongoose_detail">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"></path>
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"></path>
                ...
                {router.pathname == '/engineer/SQL/2/engineer_mongoose_detail' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">Mongoose</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">Mongoose</span>
                )}
              </div>
            </Link>
          </nav>
    ...
    <div className="bg-gray-200">
      <div className="bg-gray-900">
        <div>
          ...
          <nav className="">
            <Link href="./engineer_python_detail">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"></path>
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"></path>
                ...
                {router.pathname == '/engineer/python/1/engineer_python_detail' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">SQL</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">SQL</span>
                )}
              </div>
            </Link>
            <Link href="./engineer_python_detail1">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"></path>
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"></path>
                ...
                {router.pathname == '/engineer/python/1/engineer_python_detail1' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">Pythonインストール</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">Pythonインストール</span>
                )}
              </div>
            </Link>
          ...
          <nav className="">
            <Link href="./1">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                ...
                {router.pathname == '/engineer/python/1/engineer_python_detail' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">Windows Server</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">Windows Server</span>
                )}
              </div>
            </Link>
            <Link href="./2">
          ...
          <nav className="">
            ...
            <Link href="./engineer_react_detail_base">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                ...
                {router.pathname == '/engineer/react/0/engineer_react_detail_base' ? (
                  <span class="mx-3 text-2xl text-white bg-gray-500">React基礎</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">React基礎</span>
                )}
            ...
            <Link href="./engineer_react_detail_base_dom">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                ...
                {router.pathname == '/engineer/react/0/engineer_react_detail_base_dom' ? (
                  <span class="mx-3 text-2xl text-white bg-gray-500">React基礎(DOMの仕組み)</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">React基礎(DOMの仕組み)</span>
                )}
...
export function Chaptertypescript() {
  const router = useRouter()
  console.log(router.pathname)
  return (
          ...
          <nav className="">
            <Link href="./engineer_react_detail">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                ...
                {router.pathname == '/engineer/react/0/engineer_react_detail' ? (
                  <span class="mx-3 text-2xl text-white bg-gray-500">Nextjsとは</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">Nextjsとは</span>
                )}
              </div>
            </Link>
            <Link href="./engineer_nextjs_detail_pre">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"></path>
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"></path>
                </svg>
                {router.pathname == '/engineer/react/0/engineer_nextjs_detail_pre' ? (
                  <span class="mx-3 text-2xl text-white bg-gray-500">Pre-rendering</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">Pre-rendering</span>
                )}

              </div>
            </Link>
            <Link href="./engineer_nextjs_detail_get">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"></path>
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"></path>
                ...
                {router.pathname == '/engineer/react/0/engineer_react_detail_base' ? (
                  <span class="mx-3 text-2xl text-white bg-gray-500">getStaticProps</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">getStaticProps</span>
                )}
              </div>
            </Link>
            <Link href="./engineer_nextjs_detail_get">
...
export function Chapternextjs1() {
  const router = useRouter()
  console.log(router.pathname)
  return (
    ...
    <div className="bg-gray-200">
      <div className="bg-gray-900">
        <div>
          ...
          <nav className="">
            <Link href="./engineer_nextjs_detail">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"></path>
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"></path>
                </svg>
                {router.pathname == '/engineer/react/nextjs/1/engineer_nextjs_detail' ? (
                  <span class="mx-3 text-2xl text-white bg-gray-500">Next.jsでページ共通の処理をする</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">Next.jsでページ共通の処理をする</span>
                )}
              </div>
            </Link>
            <Link href="./engineer_react_detail_project">
          ...
          <nav className="">
            <Link href="./php_1">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                ...
                {router.pathname == '/engineer/python/1/engineer_python_detail' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">PHP</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">PHP</span>
                )}
              </div>
            </Link>
            <Link href="./php_2">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                ...
                {router.pathname == '/engineer/python/1/engineer_python_detail' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">PHP2</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">PHP2</span>
                )}
              </div>
            </Link>
          </nav>
          ...
          <nav className="">
            <Link href="./engineer_python_detail">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                ...
                {router.pathname == '/engineer/python/1/engineer_python_detail' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">Python</span>
                ) : (
            ...
            <Link href="./jupyter">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                ...
                {router.pathname == '/engineer/python/jupyter' ? (
            ...
            <Link href="./basic">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                ...
                {router.pathname == '/engineer/python/basic' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">Python基礎</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">Python基礎</span>
                )}
              </div>
            </Link>
            <Link href="./function">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                ...
                {router.pathname == '/engineer/python/function' ? (
            ...
            <Link href="./re">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                ...
                {router.pathname == '/engineer/python/re' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">モジュール</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">モジュール</span>
                )}
              </div>
            </Link>
            <Link href="./sqlite3">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                ...
                {router.pathname == '/engineer/python/sqlite3' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">データベース</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">データベース</span>
                )}
              </div>
            </Link>
            <Link href="./error">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                ...
                {router.pathname == '/engineer/python/error' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">error</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">error</span>
                )}
              </div>
            </Link>
          </nav>
...
export function ChapterPython2() {
  const router = useRouter()
  console.log(router.pathname)
  return (
    ...
    <div className="bg-gray-200">
      <div className="bg-gray-900">
        <div>
          ...
          <nav className="">
            <Link href="./engineer_python_detail_example">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"></path>
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"></path>
                ...
                {router.pathname == '/engineer/python/engineer_python_detail_example' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">フォルダー作成</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">フォルダー作成</span>
                )}
              </div>
            </Link>
...
export function ChapterPython3() {
  const router = useRouter()
  console.log(router.pathname)
  return (
          ...
          <nav className="">
            <Link href="./python_detail_numpy">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                ...
                {router.pathname == '/engineer/python/3/python_detail_numpy' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">Numpy</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">Numpy</span>
                )}
              </div>
            </Link>
            <Link href="./python_detail_pandas">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"></path>
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"></path>
                ...
                {router.pathname == '/engineer/python/3/python_detail_pandas' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">Pandas</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">Pandas</span>
                )}
              </div>
            </Link>
            <Link href="./python_detail_matplotlib">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"></path>
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"></path>
                ...
                {router.pathname == '/engineer/python/3/python_detail_matplotlib' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">matplotlib</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">matplotlib</span>
                )}
              </div>
            </Link>
            <Link href="./python_detail_settlement">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"></path>
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"></path>
                ...
                {router.pathname == '/engineer/python/3/engineer_python_detail_settlement' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">決算情報を取得</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">決算情報を取得</span>
                )}
              </div>
            </Link>
          </nav>
...
export function ChapterPython4() {
  const router = useRouter()
  console.log(router.pathname)
  return (
    ...
    <div className="bg-gray-200">
      <div className="bg-gray-900">
        <div>
          ...
          <nav className="">
            <Link href="./engineer_python_detail_fx">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"></path>
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"></path>
                ...
                {router.pathname == '/engineer/python/3/engineer_python_detail_fx' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">株価を取得、グラフチャート表示</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">株価を取得、グラフチャート表示</span>
                )}
              </div>
            </Link>
            <Link href="./engineer_python_detail_settlement">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"></path>
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"></path>
            ...
            <Link href="./engineer_python_detail_industry">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"></path>
                  <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"></path>
                ...
                {router.pathname == '/engineer/python/3/engineer_python_detail_industry' ? (
                  <span class="mx-3 text-2xl text-white bg-red-500">業種別の株価を一覧で確認</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">業種別の株価を一覧で確認</span>
                )}
              </div>
            </Link>
          </nav>
...
export function ChapterWordpress() {
  const router = useRouter()
  console.log(router.pathname)
  return (
          ...
          <nav className="">
            <Link href="./wordpress_detail">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                ...
                {router.pathname == '/engineer/web_scraping/6/engineer_scraping6_1' ? (
                  <span class="mx-3 text-2xl text-white bg-gray-500">wordpressについて</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">wordpressについて</span>
                )}
              </div>
            </Link>
            <Link href="./wordpress_theme">
              <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"></path>
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"></path>
                ...
                {router.pathname == '/engineer/web_scraping/6/engineer_scraping6_1' ? (
                  <span class="mx-3 text-2xl text-white bg-gray-500">wordpress(テーマ)</span>
                ) : (
                  <span class="mx-3 text-2xl text-white">wordpress(テーマ)</span>
                )}
              </div>
            </Link>
          </nav>

...
export function Life({ life }) {
  return (
      <div className="flex bg-white my-4">
        ...
        <p className="p-1 text-2xl ">{life.name}</p>
          <span className="p-1 text-2xl">{life.title}</span>
...
export function Skin({ skin }) {
  return (
      <div className="flex bg-white my-4">
        ...
        <div className="w-full m-4">
        <p className="p-1 text-2xl ">{skin.name}</p>
          <span className="p-1 text-2xl">{skin.title}</span>
          <div className="mt-3 justify-end flex">
            <Link href={`${skin.href}`}>
              <div>
                <button className="text-green-300 runded-full border px-6 py-2 rounded-sm">
